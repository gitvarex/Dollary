...
class RentGUI3:
    def __init__(self, return_to_home, rent_angkasa, properties1, properties2, properties3):
        """
        Initialize the RentGUI3 class.

        Parameters:
            return_to_home (function): Function to return to the home screen.
            rent_angkasa (function): Function to handle renting Angkasa Condominiums property.
        ...
        self.rental_label.pack(pady=3)  # Placing rental label
        ...
        self.angkasa_booked = False  # Flag to track if Angkasa Condominiums property is booked
                ...
                if total_price > 0:  # Checking if total price is valid
                    for prop_list in [self.properties1, self.properties2, self.properties3]:  # Iterating over property lists
                        for property_info in prop_list:  # Iterating over properties in each list
                            if property_info["name"] == "Angkasa Condominiums":  # Checking if property name matches
